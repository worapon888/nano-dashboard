export declare const USER_EVENTS_PUBLISHER = "USER_EVENTS_PUBLISHER";
export declare const MARKET_EVENTS_PUBLISHER = "MARKET_EVENTS_PUBLISHER";
export declare const WS_CONNECTIONS_PROVIDER = "WS_CONNECTIONS_PROVIDER";
